...
class Diana7Env(gym.Env):
    ...
    def __init__(self, render_mode=None):
        ...
        self._arm = Arm(
            xml_path= os.path.join(
                ...
                '../assets/robots/diana7/diana7.xml',
            ),
    ...
    def reset(self, seed=None, options=None) -> tuple:
        ...
        with self._physics.reset_context():
            ...
            # <key qpos='0.12646 -0.348087 -0.0768774 2.3714 -0.205933 -1.13729 0.376165'/>
            ...
            # put target in a reasonable starting position, the position of red cube in the arena
